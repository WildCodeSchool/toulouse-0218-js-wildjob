...
CREATE TABLE IF NOT EXISTS `Entite` (
  ...
  `region` ENUM('Nord-Ouest','Sud-Ouest','Sud-Est','Nord-Est','Centre-IdF'),
  `email` VARCHAR(45) NULL,
  `site` VARCHAR(45) NULL,
  `telephone` VARCHAR(45) NULL,
  `type` ENUM('Entreprise','Ecosystème'),
  `soustype` ENUM('ESN','Startup','Agence web', 'Editeur','Incubateur','Coworking'),
  `latitude` FLOAT,
  `longitude` FLOAT,
  `nbCDI` INTEGER DEFAULT 0,
  `nbCDD` INTEGER DEFAULT 0,
  `nbStage` INTEGER DEFAULT 0,
  `nbAlternance` INTEGER DEFAULT 0,
  -- `idLieu` INT NULL,
  -- `idEntite` INT NULL,
  -- `idContrat` INT NULL,
  PRIMARY KEY (`id`)
